...
def run_attack_on_tf_estimator_model(
  ...
  if len(in_train) == 2:
    ...
    in_train_data, in_train_labels, in_train_sample_weights = in_train
  else:
    raise ValueError('`in_train` should be length 2 or 3, received '
                     f'{len(in_train)}')
  if len(out_train) == 2:
    ...
    out_train_data, out_train_labels, out_train_sample_weights = in_train
  else:
    raise ValueError('`out_train` should be length 2 or 3, received '
                     f'{len(out_train)}')
